...
% rx_power: the received power of the preamble sequence (1 x Rp^(Ntxs-1))
% weight_mat: the generated preamble; It can generated in this function,
% but we input it instead to simplify the process.
% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [est_channel, square_error_vec] = codebook_ce_mmse(rx_power, weight_mat, Ntxs, Nloop)

% Initialization
est_channel = zeros(1, Ntxs);
square_error_vec = zeros(1, Nloop);

square_error = norm(abs(est_channel * weight_mat).^2 - rx_power);
