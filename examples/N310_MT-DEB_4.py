...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0.set_center_freq(center_freq_tx, 2)
        self.uhd_usrp_sink_0.set_gain(power_gain_tx, 2)
        self.uhd_usrp_sink_0.set_antenna('TX/RX', 2)
        self.uhd_usrp_sink_0.set_bandwidth(samp_rate, 2)
        self.uhd_usrp_sink_0.set_center_freq(center_freq_tx, 3)
        self.uhd_usrp_sink_0.set_gain(power_gain_tx, 3)
    ...
    def set_power_gain_tx(self, power_gain_tx):
        ...
        self.uhd_usrp_sink_0.set_gain(self.power_gain_tx, 2)

        self.uhd_usrp_sink_0.set_gain(self.power_gain_tx, 3)
    ...
    def set_center_freq_tx(self, center_freq_tx):
        ...
        self.uhd_usrp_sink_0.set_center_freq(self.center_freq_tx, 2)
        self.uhd_usrp_sink_0.set_center_freq(self.center_freq_tx, 3)
