...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        #          ),
        #  )
        #  self.uhd_usrp_sink_3.set_clock_rate(16e6, uhd.ALL_MBOARDS)
        ...
        #  self.uhd_usrp_sink_3.set_time_unknown_pps(uhd.time_spec())
        #  self.uhd_usrp_sink_3.set_center_freq(center_freq, 0)
        #  self.uhd_usrp_sink_3.set_gain(gain, 0)
        ...
        #          ),
        #  )
        #  self.uhd_usrp_sink_2.set_clock_rate(16e6, uhd.ALL_MBOARDS)
        ...
        #  self.uhd_usrp_sink_2.set_time_unknown_pps(uhd.time_spec())
        #  self.uhd_usrp_sink_2.set_center_freq(center_freq, 0)
        #  self.uhd_usrp_sink_2.set_gain(gain, 0)
        ...
        #  print self.uhd_usrp_sink_2.get_time_last_pps().get_real_secs()
        #  print self.uhd_usrp_sink_3.get_time_last_pps().get_real_secs()
        ...
        self.connect((self.blocks_stream_mux_1, 0), (self.uhd_usrp_sink_1, 0))
        #  self.connect((self.blocks_stream_mux_2, 0), (self.uhd_usrp_sink_2, 0))
        #  self.connect((self.blocks_stream_mux_3, 0), (self.uhd_usrp_sink_3, 0))
